    ...
    if LeaPlusLC["FasterLooting"] == "On" then
        ...
        function AutoLoot:OnEvent(e, ...)
            ...
            elseif e == "PLAYER_LOGIN" or e == "ADDON_LOADED" then
                ...
                -- Auf manchen Custom-Servern (z.B. Ascension) existiert dieser Blizzard-Frame beim
                -- ADDON_LOADED/PLAYER_LOGIN Event noch nicht (er wird erst beim Öffnen des
                -- Interface-Options-Panels erzeugt). Ohne Nil-Check crasht das Addon dort.
